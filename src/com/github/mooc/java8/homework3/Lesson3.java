...
public class Lesson3 {
  ...
  static List<String> processWords(List<String> wordList, boolean parallel) {
	...
	// Select just word begin with 'l'
	//return stream.map(String::toLowerCase).filter(s -> s.startsWith("l")).collect(Collectors.toList());
